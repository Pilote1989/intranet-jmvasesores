...
var FormCheck = new Class({
	options : {
		...
		alerts : {
			...
			alphanum     : "El campo solo acepta caracteres alfanumericos.",
			nodigit      : "No se permiten digitos.",
			digit        : "Por favor ingrese solo digitos.",
			digitmin     : "El numero debe ser mayor a %0",
			digitltd     : "El numero debe estar entre %0 y %1",
			number       : "Por favor ingrese un numero valido.",
			email        : "Por favor ingrese un correo valido: <br /><span>E.g. nombre@dominio.com</span>",
			spamcheck    : "<span>2 + 3 = ???</span>",
			phone        : "Por favor ingrese un telefono valido.",
			url          : "Por favor ingrese una direccion valida url: <br /><span>E.g. http://www.domain.com</span>",
			confirm      : "El valor es distinto a %0",
			differs      : "El valor debe ser distinto a %0",
			length_str   : "Texto muy corto, debe ser entre %0 y %1",
			lengthmax    : "Texto muy largo, debe ser tener un maximo de %0",
			lengthmin    : "Texto muy corto, debe ser tener un minimo de %0",
			checkbox     : "Please check the box",
			radios       : "Please select a radio",
			select       : "Por favor seleccione un campo"
		},
