...
/*
					$list.append($('<li class="multiple_emails-email"><span class="email_name" data-email="asfas@asfs.com">asfas@asfs.com</span></li>')
...
*/
			...
			var $input = $('<input type="text" class="multiple_emails-input text-left" placeholder="ejemplo@ejemplo.com"/>').on('keydown', function(e) { // input
