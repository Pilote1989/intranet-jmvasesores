	...
	function cuponesPorVencer($dias=10){
		$result = mysql_query("
			...
			WHERE c.idPoliza = p.idPoliza
					...
					AND DATE(c.fechaVencimiento) < ADDDATE(DATE(NOW()), " . $dias . ")
