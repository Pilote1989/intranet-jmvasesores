...
class adLDAP {
    ...
    */    
    protected function adldap_schema($attributes){
        ...
        if ($attributes["address_city"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["l"][0]=$attributes["address_city"]; }
        if ($attributes["address_code"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["postalCode"][0]=$attributes["address_code"]; }
        //if ($attributes["address_country"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["countryCode"][0]=$attributes["address_country"]; } // use country codes?
        if ($attributes["address_country"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["c"][0]=$attributes["address_country"]; }
        if ($attributes["address_pobox"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["postOfficeBox"][0]=$attributes["address_pobox"]; }
        if ($attributes["address_state"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["st"][0]=$attributes["address_state"]; }
        if ($attributes["address_street"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["streetAddress"][0]=$attributes["address_street"]; }
        if ($attributes["company"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["company"][0]=$attributes["company"]; }
        if ($attributes["change_password"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["pwdLastSet"][0]=0; }
        if ($attributes["department"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["department"][0]=$attributes["department"]; }
        if ($attributes["description"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["description"][0]=$attributes["description"]; }
        if ($attributes["display_name"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["displayName"][0]=$attributes["display_name"]; }
        if ($attributes["email"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["mail"][0]=$attributes["email"]; }
        if ($attributes["expires"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["accountExpires"][0]=$attributes["expires"]; } //unix epoch format?
        if ($attributes["firstname"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["givenName"][0]=$attributes["firstname"]; }
        if ($attributes["home_directory"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["homeDirectory"][0]=$attributes["home_directory"]; }
        if ($attributes["home_drive"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["homeDrive"][0]=$attributes["home_drive"]; }
        if ($attributes["initials"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["initials"][0]=$attributes["initials"]; }
        if ($attributes["logon_name"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["userPrincipalName"][0]=$attributes["logon_name"]; }
        if ($attributes["manager"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["manager"][0]=$attributes["manager"]; }  //UNTESTED ***Use DistinguishedName***
        if ($attributes["office"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["physicalDeliveryOfficeName"][0]=$attributes["office"]; }
        if ($attributes["password"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["unicodePwd"][0]=$this->encode_password($attributes["password"]); }
        if ($attributes["profile_path"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["profilepath"][0]=$attributes["profile_path"]; }
        if ($attributes["script_path"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["scriptPath"][0]=$attributes["script_path"]; }
        if ($attributes["surname"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["sn"][0]=$attributes["surname"]; }
        if ($attributes["title"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["title"][0]=$attributes["title"]; }
        if ($attributes["telephone"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["telephoneNumber"][0]=$attributes["telephone"]; }
        if ($attributes["mobile"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["mobile"][0]=$attributes["mobile"]; }
        if ($attributes["pager"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["pager"][0]=$attributes["pager"]; }
        if ($attributes["ipphone"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["ipphone"][0]=$attributes["ipphone"]; }
        if ($attributes["web_page"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["wWWHomePage"][0]=$attributes["web_page"]; }
        if ($attributes["fax"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["facsimileTelephoneNumber"][0]=$attributes["fax"]; }
        if ($attributes["enabled"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["userAccountControl"][0]=$attributes["enabled"]; }
        
        // Distribution List specific schema
        if ($attributes["group_sendpermission"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["dlMemSubmitPerms"][0]=$attributes["group_sendpermission"]; }
        if ($attributes["group_rejectpermission"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["dlMemRejectPerms"][0]=$attributes["group_rejectpermission"]; }
        
        // Exchange Schema
        if ($attributes["exchange_homemdb"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["homeMDB"][0]=$attributes["exchange_homemdb"]; }
        if ($attributes["exchange_mailnickname"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["mailNickname"][0]=$attributes["exchange_mailnickname"]; }
        if ($attributes["exchange_proxyaddress"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["proxyAddresses"][0]=$attributes["exchange_proxyaddress"]; }
        if ($attributes["exchange_usedefaults"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["mDBUseDefaults"][0]=$attributes["exchange_usedefaults"]; }
        if ($attributes["exchange_policyexclude"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["msExchPoliciesExcluded"][0]=$attributes["exchange_policyexclude"]; }
        if ($attributes["exchange_policyinclude"file:///C|/Users/Tatito/Desktop/adLDAP/]){ $mod["msExchPoliciesIncluded"][0]=$attributes["exchange_policyinclude"]; }
